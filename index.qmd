...
sessions_df <- sessions_all |>
  ...
  transmute(
    ...
    start = as.POSIXct(session_start, tz = "UTC") + minutes(offset_secs(tz_str)/60),
    end   = as.POSIXct(session_end,   tz = "UTC") + minutes(offset_secs(tz_str)/60)
  ) |>
  clip_to_window()
...
activity_colors <- c(
  "Sleep" = "#111111", "Personal Care" = "#555555",
  "Video Gaming" = "#107C10", "Offline Leisure & Social Life" = "#777777",
  "Other Digital Media Use" = "#333333"
)
...
ggplot() +
  ...
  geom_segment(data = sessions_df,
               ...
               linewidth = 40, lineend = "butt", how.legend = FALSE) +
  ...
  scale_y_continuous(breaks = c(1, 2, 3),
                     labels = c("Survey", "Xbox Telemetry", "Diary"),
