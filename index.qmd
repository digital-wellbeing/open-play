...
Existing use of trace data in video games typically takes the form of eithe game analytics research, often conducted in collaboration with industry at the level of an individual game, typically focused on industry-relevant behavioral rather than harms and benefits; or narrow-scope investigations into play and health within a single game or gaming platform (e.g., Xbox). Each of these approaches has limitations that constrain their utility for understanding gaming behavior in the wild.
...
sankey_data <- intake |>
  ...
  make_long(Screening, Linking, `Account\nValidation 1`, `Account\nValidation 2`, Surveys) |>
...
ggplot(
  ...
  geom_sankey_label(parse = FALSE, size = 1.8, color = "white", fill = "gray40", vjust = 1.4) +
