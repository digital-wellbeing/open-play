...
platforms_count <- str_count(replace_na(intake$linked_platforms[intake$qualified], ""), ",") + 1
...
overview <- overview |>
  mutate(
    ...
    `Observable Period` = case_match(
      ...
      "Steam"             ~ "3-12 months",
      "Nintendo"          ~ paste0(floor(time_length(interval(min(nintendo$session_start, na.rm = TRUE),
                                                              max(nintendo_raw$time_of_pull,  na.rm = TRUE)), 
                                                     "months")) + 1,
                                                     " months"),
      "Xbox"              ~ paste0(floor(time_length(interval(min(xbox$session_start, na.rm = TRUE),
