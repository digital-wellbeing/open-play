...
age_uk <- read_csv("data/census/TS009-2021-2-filtered-2025-03-05T23-18-32Z.csv") |>
  pivot_wider(
...
ethnicity_uk <- read_csv("data/census/TS021-2021-1-filtered-2025-03-05T23-25-05Z.csv") |>
...
education_uk <- read_csv("data/census/TS067-2021-3-filtered-2025-03-05T23-37-22Z.csv") |>
  select(4:5) |>
