...
if (knitr::is_html_output()) {
  ...
  # Create initial table with plots
  tbl_html <- tt(table_data) |>
    ...
    style_tt(j = c(9, 10, 11), align = "c") |>
    style_tt(fontsize = 0.8)
  
  # Just print the table - tinytable will handle the rendering
  # Note: Post-processing to replace plots with "—" for complete missingness rows
  # is not easily done in Quarto context, so rows with 0 data will show minimal plots
  tbl_html
} else {
