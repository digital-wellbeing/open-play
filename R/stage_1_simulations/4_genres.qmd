...
panel <- fread("data/synthetic/data-synthetic-clean/synPanelClean.csv.gz") |> 
  mutate(
...
diary <- read_csv("data/synthetic/data-synthetic-clean/synDiaryClean.csv.gz")
intake <- read_csv("data/synthetic/data-synthetic-clean/synIntakeClean.csv.gz")
ninRaw <- read_csv("data/synthetic/data-synthetic-clean/synNintendoClean.csv.gz")
xboxRaw <- read_csv("data/synthetic/data-synthetic-clean/synXboxClean.csv.gz") 
steamRaw <- read_csv("data/synthetic/data-synthetic-clean/synSteamClean.csv.gz")
iOSRaw <- read_csv("data/synthetic/data-synthetic-raw/syniOS.csv.gz")
androidRaw <- read_csv("data/synthetic/data-synthetic-raw/synAndroid.csv.gz")
...
# demean
aggregated_playtime <- datawizard::demean(aggregated_playtime, 
                                          select = c(genre_vars, "total_time_all_genres"), 
                                          by = "pid") |> 
