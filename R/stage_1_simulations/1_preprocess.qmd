...
synDiary <- read_csv("data/synthetic/data-synthetic-raw/synDiary.csv.gz")

# for unknown reasons, read_csv imports some columns incorrectly, so we use data.table::fread
synPanel <- fread("data/synthetic/data-synthetic-raw/synPanel.csv.gz") 
synIntake <- read_csv("data/synthetic/data-synthetic-raw/synIntake.csv.gz")

synNintendo <- read_csv("data/synthetic/data-synthetic-raw/synNintendo.csv.gz") |>
  mutate(sessionEnd = sessionStart + minutes(round(duration)), .after = sessionStart)
synXbox <- read_csv("data/synthetic/data-synthetic-raw/synXbox.csv.gz") |>
  mutate(sessionEnd = sessionStart + minutes(round(duration)), .after = sessionStart)
synSteam <- read_csv("data/synthetic/data-synthetic-raw/synSteam.csv.gz")
syniOS <- read_csv("data/synthetic/data-synthetic-raw/syniOS.csv.gz")
synAndroid <- read_csv("data/synthetic/data-synthetic-raw/synAndroid.csv.gz")
```
...
write_csv(synIntakeClean, "data/synthetic/data-synthetic-clean/synIntakeClean.csv.gz")
write_csv(synDiaryClean, "data/synthetic/data-synthetic-clean/synDiaryClean.csv.gz")
write_csv(synPanelClean, "data/synthetic/data-synthetic-clean/synPanelClean.csv.gz")
write_csv(synNintendoClean, "data/synthetic/data-synthetic-clean/synNintendoClean.csv.gz")
write_csv(synXboxClean, "data/synthetic/data-synthetic-clean/synXboxClean.csv.gz")
write_csv(synSteamClean, "data/synthetic/data-synthetic-clean/synSteamClean.csv.gz")
write_csv(syniOS, "data/synthetic/data-synthetic-clean/syniOSClean.csv.gz")
write_csv(synAndroidClean, "data/synthetic/data-synthetic-clean/synAndroidClean.csv.gz")
