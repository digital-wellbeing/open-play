...
time_use_data <- read_csv("data_minimal/raw/timeuse_diary.csv")
```
...
write_csv(ai_inspection, "data_minimal/processed/ai_classification_inspection2.csv")
```
...
manual_corrections <- read_delim("data_minimal/processed/ai_classification_inspection_manual.csv", 
                                delim = ";", 
...
write_csv(final_dataset, "data_minimal/clean/timeuse_diaryClean.csv")
```
