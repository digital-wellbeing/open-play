...
```{r}
#| label: load-data
#| cache.extra: !expr file.mtime("data-minimal-pseudo/survey_intake.csv.gz")
...
idle_games <- source(here("data-minimal-pseudo/idle_titles_vector.txt"))$value
non_games <- source(here("data-minimal-pseudo/non_games_vector.txt"))$value
...
# TODO: nintendo data quality checks
tol <- dseconds(60)
...
[^data-ms-2]: In previous research, Nint endo -published games accounted for 65% of Switch playtime [@BallouEtAl2025Perceived]
...
knitr::include_graphics(here("manuscripts/data-ms/design.png"))
```
